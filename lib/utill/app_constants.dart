...
class AppConstants {
  ...
  static const String VERIFY_PASSWORD_TOKEN_URI =
      '/api/v1/auth/verify-password-token';
  ...
  static const String UPDATE_PERSONAL_INFO_URI =
      '/api/v1/user/profile/update-admin';
  ...
  static const String UPDATE_USER_AREAS_URI =
      '/api/v1/user/location/worker/update-worker-areas';

  // waypoints
  static const String WAYPOINTS_LIST_URI =
      '/api/v1/user/location/waypoints/waypoints-list';
  static const String STORE_POINT_URI =
      '/api/v1/user/location/waypoints/store-waypoint';
  static const String UPDATE_POINT_URI =
      '/api/v1/user/location/waypoints/update-waypoint';
  static const String DELETE_POINT_URI =
      '/api/v1/user/location/waypoints/remove-waypoint';

  /// Workers
  static const String UPDATE_WORKER_DETAILS_URI =
      '/api/v1/user/worker/update-worker';
  static const String ADD_WORKER_URI = '/api/v1/user/worker/add-new';
  static const String WORKER_AREAS_LIST_URI =
      '/api/v1/user/location/worker/areas-list';
  static const String UPDATE_WORKER_BIO_URI =
      '/api/v1/user/profile/update-worker-bio';
  static const String SELECT_USERS_URI =
      '/api/v1/user/location/waypoints/select-users-waypoint';
  ...
  static const String GET_WORKER_WAYPOINTS_URI =
      '/api/v1/worker/waypoints/list';
  static const String GET_WORKER_WAYPOINTS_TODAY_URI =
      '/api/v1/worker/waypoints/list';
  static const String GET_WORKER_TASKS_URI =
      '/api/v1/worker/tasks/admin-tasks-list';
  static const String UPDATE_PINPOINT_TASK_URI =
      '/api/v1/worker/tasks/update-task';
  static const String TASK_REMINDER_URI = '/api/v1/worker/tasks/task-reminder';
  static const String STORE_WORKER_WAYPOINT_URI = '';
  static const String UPDATE_WORKER_WAYPOINT_URI = '';
  static const String DELETE_WORKER_WAYPOINT_URI = '';

  ///admin
  static const String STORE_TASK_URI = '/api/v1/user/task/add-task';
  static const String GET_TASK_URI = '/api/v1/user/task/tasks-list';
  static const String POST_PERMISSION_URI =
      '/api/v1/user/worker/update-permissions';
  static const String GET_ADMIN_PINPOINT_TASKS_LIST_URI =
      '/api/v1/user/task/admin-tasks-list';

  ///Reports
  static const String ALL_TASKS_REPORT_URI =
      '/api/v1/user/reports/all-tasks-report';
  ...
  static const String API_KEY =
      'AIzaSyBIbAyozsooyfTl49xleURPX7424AUJpuA'; // TEMPORARY
