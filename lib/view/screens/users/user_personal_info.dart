...
class UserPersonalInfo extends StatefulWidget {
  ...
  UserPersonalInfo({@required this.user});
  @override
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          FadeInImage.assetNetwork(
                                            ...
                                            image: '${Provider.of<SplashProvider>(context,).baseUrls!.userImageUrl}/${widget.user!.image}',
                                  ...
                                  child: CustomButton(btnTxt: 'Update',
                                      onTap: () async {
                                        ...
                                        // }
                                          ...
                                          workerProvider.updateWorkerInfo(token, signUpModel, widget.user!.id!).then((value) {
                                            if(value.statusCode == 200){
                                              workerProvider.getWorkersList(context);
                                              showCustomSnackBar('Worker\'s Profile Updated!', context, isError:false);
                                            }else{
