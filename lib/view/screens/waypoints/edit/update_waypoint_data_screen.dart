...
class UpdateWaypointDataScreen extends StatefulWidget {
  final WaypointModel? waypoint;
  UpdateWaypointDataScreen({@required this.waypoint});
  @override
  State<UpdateWaypointDataScreen> createState() =>
      _UpdateWaypointDataScreenState();
}

class _UpdateWaypointDataScreenState extends State<UpdateWaypointDataScreen> {
                          ...
                          onTap: () {
                            ...
                            if (_nameController!.text.trim().isEmpty) {
                              ...
                              locationProvider
                                  ...
                                  .then((value) {
                                if (value.isSuccess) {showCustomSnackBar('Waypoint updated successfully', context, isError: false);
